...
There are many community developed tools to determine returns. You can also read more in the docs about how to think about [Liquidity Pool returns](/docs/v2/advanced-topics/understanding-returns/).

## Protocol Fees

At the moment there are no protocol fees. However, it is possible for a 0.05% fee to be turned on in the future.

More information about a potential future protocol fee can be found [here](https://uniswap-rsk.comblog/uniswap-v2/#path-to-sustainability).
