...
Ultimately, of course, the Uniswap protocol is just smart contract code running on RSK. To understand how they work, head over to <Link to="/docs/v2/protocol-overview/smart-contracts/">Smart Contracts</Link>.
