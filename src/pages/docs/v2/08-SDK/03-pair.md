...
The Pair entity represents a RSK Swap pair with a balance of each of its pair tokens.
...
Computes the pair address for the passed <Link to='/docs/v2/SDK/token'>Token</Link>s. See <Link to='/docs/v2/smart-contract-integration/getting-pair-addresses/'>Pair Addresses</Link>.
