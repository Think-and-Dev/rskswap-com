...
<Info>
  Uniswap V1 does not exists on RSK, and while still fully functional on ehtereum, is no longer under active development. Looking for <Link style={{ display: "contents" }} to='/docs/v2/'>V2 documentation</Link>?
</Info>
